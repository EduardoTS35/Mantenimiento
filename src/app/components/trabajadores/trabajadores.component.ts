...
import { dialogTrabajadores } from 'src/app/common/dialogTrabajadores/dialogTrabajadores';
...
export class TrabajadoresComponent implements OnInit {
    ...
    constructor(public dialog:MatDialog,
                ...
                private trabajadorService: ApiTrabajadorService, 
    ...
    openAdd(){
    const dialogRef=this.dialog.open(dialogTrabajadores,{
    });
  ...
  openEdit(trabajador:Trabajadores){
    this.trabajadorService.getTrabajador(trabajador);
    const dialogRef=this.dialog.open(dialogTrabajadores,{      
    });
    ...
    deleteTrabajador(trabajador: Trabajadores) {
        ...
        const dialogRef=this.dialog.open(DialogDeleteComponent,{
          ...
          dialogRef.afterClosed().subscribe(result=>{
            if(result===true){
              this.trabajadorService.deleteTrabajadores(trabajador.idTrabajador).subscribe(response=>{
                if(response.exito === 1){
